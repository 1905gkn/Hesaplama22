(() => {
  const VERSION = "front-side-capture-v29";
  ...
  async function captureCombinedVariants(){
    ...
    combinedVariantPending=(async()=>{
      ...
      const result=await capture(base,{width:3600,height:1800,pixelRatio:2.25,cameraPadding:.95,frontDimensions:{levels:true,markers:true,eye:true,width:false,depth:false},sideDimensions:{levels:false,markers:false,eye:false,width:false,depth:true},side:"right"});
