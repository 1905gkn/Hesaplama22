...
if (!html.includes('data-rafex-common-gap-performance="v84"')) html = html.replace('</head>', '<meta data-rafex-common-gap-performance="v84"></head>');
...
worker = worker.replace(match[3], encoded);
