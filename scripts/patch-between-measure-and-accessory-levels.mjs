...
#m2CustomizeModal .m2-customize-dialog{contain:layout paint style}
  ...
  function isGroundStart(){if(byId('m2CustomizeTunnel')?.checked)return false;const r=activeCustomizeRack();const v=String(r?.b2b?.firstPalletPosition||r?.firstPalletPosition||'ground').toLowerCase();return v==='ground'||v==='zemin';}
