...
assert.match(portal,/planClearanceMm = Math\.max\(75, palletGapMm\)/,'Plan view must reserve at least 75 mm');
assert.match(portal,/rack\.x \+ uprightW \+ planGapPx/,'Pallet placement must start after the visible upright and its clearance');
assert.match(source,/upright-75mm-v125/,'The upright-aware 75 mm clearance marker must be present');
