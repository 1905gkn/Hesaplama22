...
const js=['client/tray-calculator.js','client/rack-tray-selection.js','client/mr-tray-selection.js'].map(file=>fs.readFileSync(file,'utf8').replace('__TRAY_DATA__',fs.readFileSync('client/tray-capacities.json','utf8')).replace('__TRAY_CALCULATE__',calculateTray.toString())).join('\n');
