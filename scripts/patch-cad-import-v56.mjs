...
for (const required of [marker, "AutoCAD’den Aktar", "rafex_alan:'area'", "pathBreaks.push(layoutPoints.length-1)", "payload?.projectName", "window.rafexImportCadFileV56"]) {
