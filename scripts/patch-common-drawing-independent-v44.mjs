...
.rafex-common-cut-label{font-weight:950!important;color:#0b2b45!important}
  ...
  function syncPdfHost(host){
    ...
    cards.forEach(function(card,index){
      ...
      if(head){var span=head.querySelector('span');if(span&&span.textContent!==group.letter+' · '+label)span.textContent=group.letter+' · '+label;head.querySelectorAll('.rafex-common-system-badge').forEach(function(badge){badge.remove();});}
    });
