...
(function(){
 ...
 function calculate(forceAuto){
   ...
   var lift=Math.max(0,n('konsolLiftClearance',100)),productHeight=Math.max(50,n('konsolLevelGap',1000)-lift),loadType=window.__rafexKonsolLoadType||'profile',loadLabel=loadType==='pallet'?'paletli yük':(loadType==='unpacked'?'boş raf':'kutu profil bağı');
