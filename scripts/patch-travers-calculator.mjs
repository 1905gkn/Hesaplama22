...
const rackJs=fs.readFileSync('client/rack-travers-selection.js','utf8').replace('__RACK_NORMAL__',JSON.stringify(data)).replace('__RACK_COLLECTION__',fs.readFileSync('client/mini-rack-table.json','utf8'));
