...
const marker = 'data-rafex-login-home-sidebar="v2"';
if (!html.includes(marker)) {
  const style = `<style ${marker}>
/* Şifre/giriş ekranında soldaki tanıtım alanı ve uygulama menüsü görünmesin. */
...
/* Yalnızca giriş yapıldıktan sonra uygulama sol menüsü Ana Sayfa dahil sabit/tam boy kalsın. */
...
console.log("Giriş ekranı menüsüz bırakıldı; uygulama yan menüsü Ana Sayfa dahil sabit/tam boy yapıldı.");
