...
source = source.replace('const ASSET_VERSION = "b2b-shared-upright-widths-514";', 'const ASSET_VERSION = "b2b-shared-upright-widths-514";');
...
let portalSource = fs.readFileSync(portalPath, 'utf8')
  ...
  .replaceAll('b2b-double-row-side-ties-367', 'b2b-shared-upright-widths-514');
