...
source = source.replace('const ASSET_VERSION = "b2b-true-3d-combined-510";', 'const ASSET_VERSION = "b2b-true-3d-combined-510";');
...
let portalSource = fs.readFileSync(portalPath, 'utf8')
  ...
  .replaceAll('b2b-double-row-side-ties-367', 'b2b-true-3d-combined-510');
