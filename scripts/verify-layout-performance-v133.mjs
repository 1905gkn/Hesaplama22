...
try{
  ...
  for(const key of ['undo','rotated','duplicated','dragged','dragRetained','dragUndo','links','undoEmpty','ownedTypes','sourceIntact','reopen','commonOwned','refreshOwned','imported','noDuplicateImport','commonLog','oneDeleted','localDelete','newProjectEmpty','newIdentity','newProjectUi','oldRecordsIntact','reportCleared','button'])assert(flows[key],key);
