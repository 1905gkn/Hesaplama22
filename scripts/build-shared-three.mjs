...
html=html.replace(/\/(b2b|mr|konsol|mekik-front|drive-in)-viewer\.js(?:\?[^"'\s<>]*)?/g,'/$1-viewer.js?v=shared-three-v1');
const first=html.indexOf('<script');html=html.slice(0,first)+'<script src="/rafex-three.js?v=shared-three-v1"></script>'+html.slice(first);
