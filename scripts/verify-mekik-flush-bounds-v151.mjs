...
const other = { ...base, id: 3, rafexSystem: "drive", systemType: "fifo" };
...
const rightRack = { ...explicit, id: 4, x: explicit.x + explicit.w };
const right = context.m2RackBounds(rightRack);
assert.equal(left.right, right.left, "Yan yana Mekik blokları 0 mm'de tam temas etmeli");
console.log("Mekik sıfır yan boşluk doğrulaması geçti.");
