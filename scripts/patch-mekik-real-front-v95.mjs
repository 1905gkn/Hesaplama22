...
console.log("v95: Mekik ana Önden Görünüş gerçek Three.js GLB renderer'a alındı; doğru X/Z ön ekseni, ortografik kamera ve gerçek GLB mesh/malzeme aktif. v94 2D projeksiyon kaldırıldı.");
