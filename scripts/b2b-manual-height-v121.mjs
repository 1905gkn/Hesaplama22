...
const options=b2b3DOptions;b2b3DOptions=window.b2b3DOptions=function(){const base=options.apply(this,arguments);return mainRows.length?manualOptions(base,mainRows):{...automaticOptions(base),firstFloorGap:base.firstFloorGap}};
