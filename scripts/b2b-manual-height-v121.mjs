...
function open(kind){
 ...
 };window.RafexRackTravers?.bindLevels(dialog,Number(o.sectionWidth)||Number(rack?.b2bLayout?.sectionWidth)||b2bPalletGeometry().sectionWidth,ground,saved);dialog.showModal();
}
