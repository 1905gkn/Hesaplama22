...
<script data-rafex-common-layout-theme="v96">(function(){
  ...
  function sync(){frame=0;var page=document.getElementById('page');if(!page||(!page.classList.contains('rafex-common-independent')&&page.getAttribute('data-rafex-common-active')!=='1'))return;if(page.classList.contains('rafex-common-independent')&&page.getAttribute('data-rafex-common-active')!=='1')page.setAttribute('data-rafex-common-active','1');var selected=document.querySelector('#rafexUnifiedSystemPicker input[name="rafexUnifiedSystem"]:checked');var system=normalize(selected&&selected.value||page.dataset.rafexFreeContextSystem||page.dataset.freeSystem||page.dataset.rafexCommonSystem||page.dataset.m2Module);if(system)page.setAttribute('data-rafex-layout-theme',system);}
