...
for (const required of ["Math.max(8,Math.min(17,shortSide*.72))",'label.style.opacity=".98"','label.style.letterSpacing=".04em"']) if (!html.includes(required)) throw new Error("Serbest Çizim büyük blok harfi görünümü bulunamadı: " + required);
