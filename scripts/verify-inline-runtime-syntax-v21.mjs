...
for (const required of ["rowCount:rowCount,rowGap:rowGap","source?.b2b?.rowGap??source?.b2bLayout?.rowGap??200"]) if (!html.includes(required)) throw new Error("MR uzatma sıra geometrisi bulunamadı: " + required);
