...
for (const required of ['grid-template-columns:repeat(5','rafex-system-picker-head','display:none!important','ensureProject(picker)','data-rafex-authority-project-name','projectName=event.target.value']) {
